                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#edit_<?php echo $row->codigo; ?>" data-toggle="modal" class="btn btn-success btn-smv " style="padding-top:6px"><span class="glyphicon glyphicon-edit"></span> Editar</a><br><br>
                                    <a href="#delete_<?php echo $row->codigo; ?>" data-toggle="modal" class="btn btn-danger btn-sm" style="padding-top:6px"><span class="glyphicon glyphicon-trash"></span> Eliminar</a>
                                </td>
